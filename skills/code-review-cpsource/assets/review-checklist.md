...
- [ ] Each suspected bug cross-referenced against test suite
- [ ] Callers checked to confirm the problematic path is reachable
- [ ] Edge cases traced with concrete values, not intuition
- [ ] Intentional sentinel values/patterns ruled out before reporting
- [ ] Doc comments validated against tests (tests are ground truth)
- [ ] Unverified findings labeled explicitly as `[unverified]`
