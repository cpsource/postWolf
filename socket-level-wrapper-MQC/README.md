...
| [`README-mqc-issues-summary.md`](./README-mqc-issues-summary.md) | Live scoreboard of every external-review finding (mqc-1/2/3/4 + Gemini); points at the canonical write-ups in [`reviews/`](./reviews/). |
