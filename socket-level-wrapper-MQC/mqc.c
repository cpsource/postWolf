...
static struct json_object *mqc_json_parse_strict(const char *what,
...
static int mqc_json_no_duplicates(const char *what,
                                  const char *buf, int len,
...
static int mqc_json_no_unknown_keys(const char *what,
                                    struct json_object *obj,
...
static int mqc_json_get_int_strict(const char *what,
...
static int mqc_json_get_hex_strict(const char *what,
                                   struct json_object *obj, const char *field,
...
static int mqc_json_get_string_exact(const char *what,
                                     struct json_object *obj,
                                     const char *field,
